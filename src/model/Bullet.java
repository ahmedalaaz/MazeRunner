...
public class Bullet extends ImageView{
	...
	public void fire(double startX, double startY,double translateX,double translateY,Pane root) {
		...
		this.bulletImageView.setFitHeight(ICell.WALL_HEIGHT-6);
		this.bulletImageView.setFitWidth(ICell.WALL_WIDTH-3);
		bulletImageView.maxHeight(ICell.WALL_HEIGHT-6);
		bulletImageView.maxWidth(ICell.WALL_WIDTH-3);
	...
	public void stopBullet() {
		...
		ImagePattern image = new ImagePattern(new Image(MapCell.class.getClassLoader()
				.getResource("images/bulletHit.png").toExternalForm()));
		Rectangle bulletHit=new Rectangle(ICell.WALL_WIDTH , ICell.WALL_HEIGHT);
